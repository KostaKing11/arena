...
const ICONS = {
  ...
  // sa pločicom za kameru gore; bez nje je na 20 px izgledao kao čovečuljak
  tripod: 'M9 3h6v2.5H9z M5.5 5.5h13 M12 5.5v6.5 M12 12 7 21 M12 12l5 9 M12 12v9',
  ...
  /* Savez = dve karike. Rukovanje se od tankih dijagonala na 20 px pretvaralo
     u vijugu koja ne liči ni na šta — karike imaju siluetu koja se drži. */
  handshake: 'M9.2 14.8a4 4 0 0 1 0-5.6l2.2-2.2a4 4 0 0 1 5.6 5.6l-1.1 1.1 '
    + 'M14.8 9.2a4 4 0 0 1 0 5.6l-2.2 2.2a4 4 0 0 1-5.6-5.6l1.1-1.1',
