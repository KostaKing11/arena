...
const I18N = {
  sr: {
    ...
    tpBringHint: 'Tapni bota da ti dođe na 2 m — da možeš da probaš napad.', tpBrought: 'Bot je pored tebe',
    tpMe: 'Ja', tpFullHp: 'Pun život', tpRevive: 'Oživi me', tpResetSpecial: 'Vrati specijal', tpClearCd: 'Ugasi cooldown',
    tpWeapon: 'Daj mi oružje',
    tpWorld: 'Svet', tpNextZone: 'Odmah sledeća zona', tpKillBot: 'Ubij bota',
    tpFillPool: 'Napuni kasu', tpDropItem: 'Baci predmet kraj mene',
    tpWorldHint: 'Pomeranje vremena ubrzava zonu, dan i noć i događaje. Menja se samo raspored, pravila ostaju ista.',
    ...
    invEmpty: 'Torba je prazna', invFree: 'Slobodnih mesta', holdToUse: 'Drži',
    ...
    ghostInZone: 'U zoni si — vrati se napolje, ovde zbunjuješ žive igrače',
  ...
  en: {
    ...
    tpWorld: 'World', tpNextZone: 'Next zone now', tpKillBot: 'Kill a bot',
    tpFillPool: 'Fill the pool', tpDropItem: 'Drop an item near me',
    tpWorldHint: 'Skipping time speeds up the zone, day and night, and events. Only the schedule moves — the rules stay the same.',
    ...
    invEmpty: 'Your bag is empty', invFree: 'Free slots', holdToUse: 'Hold',
