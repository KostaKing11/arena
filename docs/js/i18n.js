...
const I18N = {
  sr: {
    ...
    installApp: 'Instaliraj kao aplikaciju',
    installed: 'Instalirano — otvori ARENA sa početnog ekrana',
    iosInstall: 'Da ti stoji kao prava aplikacija: tapni <b>Podeli</b> dole u Safariju, pa <b>Dodaj na početni ekran</b>.',
    updateReady: 'Nova verzija je spremna — osveži stranicu',
  ...
  en: {
    ...
    installed: 'Installed — open ARENA from your home screen',
    iosInstall: 'To keep it like a real app: tap <b>Share</b> at the bottom of Safari, then <b>Add to Home Screen</b>.',
    updateReady: 'A new version is ready — reload the page',
